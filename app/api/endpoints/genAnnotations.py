...
ns = api.namespace("genAnnotation",
                   description="Retrieve data from the GenAnnotation table.")
...
class GenAnnotationId(Resource):
    def get(self, annotation_id):
        ...
        """
        q = GenAnnotation.query.filter(
            GenAnnotation.annotationId == annotation_id).first()
