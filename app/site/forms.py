...
class QueryForm(Form):
    ...
    complete_genome = RadioField("complete_genome", choices=[("0", "Whole Database"),
                                                             ("Y", "Complete Genomes"),
                                                             ("N", "Coding Regions")], default="0")
    snp_position = StringField("snp_position", validators=[NumberRange(min=1, max=17000)],
                               default=None)
    transit = MultiCheckboxField("transit", choices=[("0", "All"), ("AG", "AG"), ("GA", "GA"),
                                                     ("CT", "CT"), ("TC", "TC")], default="0")
    transv = MultiCheckboxField("transv", choices=[("0", "All"), ("AC", "AC"), ("AT", "AT"),
                                                   ("CA", "CA"), ("CG", "CG"), ("GC", "GC"),
                                                   ("GT", "GT"), ("TA", "TA"), ("TG", "TG")],
                                default="0")
    insertion = BooleanField("insertion", default=True)
    insertion_position = StringField("insertion_position",
                                     validators=[NumberRange(min=1, max=17000)], default=None)
    ...
    start_deletion = StringField("start_deletion", validators=[NumberRange(min=1, max=17000)],
                                 default=None)
    end_deletion = StringField("end_deletion", validators=[NumberRange(min=1, max=17000)],
                               default=None)
    ...
    genome_type = RadioField("genome_type", choices=[("0", "All"), ("N", "Healthy"),
                                                     ("P", "Pathologic")], default="0")
