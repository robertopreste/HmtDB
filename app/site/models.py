...
class Disease(db.Model):
    ...
    def __repr__(self):
        ...
        diseaseAcronym: {self.diseaseAcronym}, url: {self.url}, individuals: {self.individuals}, 
        mitoAa: {self.mitoAa}, mitoDna: {self.mitoDna})""".format(self=self)
...
class Genome(db.Model):
    ...
    individualId = db.Column(db.Integer, db.ForeignKey("IndividualsData.individualId"),
...
class MitomapAa(db.Model):
    ...
    def __repr__(self):
        ...
        varDnaId3: {self.varDnaId3}, diseases: {self.diseases})""".format(self=self)
...
class MitomapDna(db.Model):
    ...
    def __repr__(self):
        ...
        rcrsType: {self.rcrsType}, geneName: {self.geneName}, diseases: {self.diseases})""".format(self=self)
